...
const Banner = () => {
  ...
  return (
    <div className="w-full h-auto overflow-x-hidden">
      <div className="w-screen h-[900px] relative">
        ...
        <div className="absolute w-fit left-0 right-0 mx-auto flex gap-8 bottom-64">
          <div
            onClick={prevSlide}
            ...
            active:bg-gray-900 duration-300 select-none">
            <HiArrowLeft />
          </div>
          <div
          onClick={nextSlide}
